    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0f172a] px-4">
      <div className="max-w-md w-full bg-[#1e293b] rounded-2xl shadow-xl p-8 border border-slate-800">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Sign in to your Expense Tracker</p>
        </div>
        ...
        <p className="text-center text-slate-400 mt-6 text-sm">
          Don't have an account? <Link to="/register" className="text-[#38bdf8] hover:text-[#0ea5e9] font-medium ml-1">Create one</Link>
        </p>
      </div>
    </div>
  );
